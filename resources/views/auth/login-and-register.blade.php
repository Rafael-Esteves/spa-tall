    ...
    <div class="grid grid-cols-2">
        ...
        <div>
            <x-jet-authentication-card>
                ...
                @endif
                <div x-data="{ open_login: false, open_register: true }">
        
        
                    <form method="POST" action="{{ route('register') }}" x-show="open_register">
                        @csrf
            ...
            'privacy_policy' => '<a target="_blank" href="' . route('policy.show') . '" class="text-sm text-gray-600 underline hover:text-gray-900">' . __('Privacy Policy') . '</a>',
                        ...
                        <div class="flex items-center justify-end mt-4">
                            ...
                            <div x-on:click="open_login = ! open_login, open_register = ! open_register"
                    ...
                    <form method="POST" action="{{ route('login') }}" x-show="open_login">
                        @csrf
